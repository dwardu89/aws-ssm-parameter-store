...
class UpdateOpsItemCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateOpsItemRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateOpsItemResponse.filterSensitiveLog,
        };
